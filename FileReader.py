	...
	with open("PZITRF08" + str(day) + ".12X", "r") as file:
		...
		for i in range(N_stations):
			for j in range(3):
				...
				covariance = correlation * covariance_matrices[i,index_1,index_1] * covariance_matrices[i,index_2,index_2]
				covariance_matrices[i,index_1,index_2] = covariance
				covariance_matrices[i,index_2,index_1] = covariance
